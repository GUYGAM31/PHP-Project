...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 26, 2020 at 08:55 PM
...
CREATE TABLE `details` (
  `Username` varchar(20) COLLATE utf8_bin NOT NULL,
  `Result` varchar(4) COLLATE utf8_bin NOT NULL,
  `Money` varchar(8) COLLATE utf8_bin NOT NULL,
  `Game` varchar(20) COLLATE utf8_bin NOT NULL,
...
('lunate', 'killernet', '12345678', 26400, 'Online');
COMMIT;
